...
public class ObstracFactory extends Layer{
	Bitmap appleTexture;
...
//    Thread timer = NSTimer()
	...
	public ObstracFactory(float x, float y, float sceneWidth, boolean autoAdd) {
		super(x, y, autoAdd);
...
//        timer = NSTimer.scheduledTimerWithTimeInterval( 0.2, target: self, selector: "createApple", userInfo: nil, repeats: true)
        createAppleTimeUtil = new GameTimeUtil(300);
	}
